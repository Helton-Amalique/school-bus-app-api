...
1. TestUserModel         — criação, validações, métodos
2. TestPerfilModels      — Encarregado, Aluno, Motorista, Gestor, Monitor
3. TestUserAPI           — endpoints /users/
4. TestEncarregadoAPI    — endpoints /encarregados/
5. TestAlunoAPI          — endpoints /alunos/
6. TestMotoristaAPI      — endpoints /motoristas/
7. TestGestorAPI         — endpoints /gestores/
8. TestMonitorAPI        — endpoints /monitores/
"""
